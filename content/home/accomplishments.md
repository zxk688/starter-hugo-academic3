...
item:
  ...
  - date_end: ""
    ...
    title: Reviewer for International Journal of Digital Earth(IF:4.606), Sustainability(IF:3.9). Mathematics(IF:2.592), Electronics(IF:2.690), Journal of Electronic Imaging(IF:0.829), IEEE Access(IF:3.476) Applied Sciences(IF:2.838) and Brazilian Archives of Biology and Technology(IF:1.18).
